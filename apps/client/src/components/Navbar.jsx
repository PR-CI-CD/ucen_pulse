...
export default function Navbar(props) {
  ...
  return (
  <nav className="bg-white text-gray-900 shadow-sm" /* aria-label="Primary" */>
    <div className="w-full flex items-center justify-between px-4 sm:px-6 lg:px-10 py-3">
      ...
      >
        ...
        <div className="flex gap-2">
          <input
            ...
            /* optional: aria-controls="desktop-search-results" */
          />
      ...
      <div className="hidden md:block relative">
        ...
        >
          ...
          <svg className={`h-4 w-4 text-gray-600 transition-transform ${avatarOpen ? "rotate-180" : ""}`} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    >
      <div className="px-4 sm:px-6 pt-3 pb-4 space-y-3">
        ...
        <form role="search" aria-label="Site search (mobile)" onSubmit={submitMobile}>
          <label htmlFor="mobile-record-search" className="sr-only">Search for a record</label> {/* changed */}
          <div className="flex gap-2">
            <input
              ref={mobileSearchRef}
              ...
              /* optional: aria-controls="mobile-search-results" */
            />
            <button
              type="submit"
          ...
          {/* <GlobalSearch value={queryMobile} id="mobile-search-results" /> if you show results here */}
        </form>
